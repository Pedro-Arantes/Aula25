    ...
    <table class="table table-success table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th > <a class="btn btn-outline-warning" href="frmcliente.php?idcliente=<?php echo $cliente->idcliente ?>">
                <img src="./img/editar.png" alt="">
                </a> </th>

                <th > <a class="btn btn-outline-danger" href="frmcliente.php?op=del&idcliente=<?php echo $cliente->idcliente ?>">
